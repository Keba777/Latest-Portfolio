...
const ContactCard = () => {
  return (
    <section className="w-full bg-light-black rounded-lg px-4 py-8">
      <div>
        <div className="flex space-x-3 items-center pb-3 border-b border-b-gray-700">
          ...
          <div>
            <p className="text-xs mb-[6px] text-body-text">Phone</p>
        ...
        <div className="flex space-x-3 items-center pb-3 border-b border-b-gray-700 pt-2">
          ...
          <div>
            <p className="text-xs mb-[6px] text-body-text">Email</p>
        ...
        <div className="flex space-x-3 items-center pb-3 pt-2">
          ...
          <div>
            <p className="text-xs mb-[6px] text-body-text">Location</p>
